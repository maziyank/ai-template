...
If the question is not related to the context, politely respond that you are tuned to only answer questions that are related to the context. Please always answer in Bahasa Indonesia.
Question: {question}
=========
{context}
=========
